  ...
  return (
    <SiteShell title={site.obsidianPage.title} eyebrow={site.obsidianPage.eyebrow}>
      <section className="py-12 sm:py-16">
        ...
        <h3 className="mt-12 text-lg text-[color:var(--text-primary)] sm:text-xl">
          {site.obsidianPage.sourceListTitle[locale]}
        </h3>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-[color:var(--text-secondary)] sm:text-base">
          {site.obsidianPage.sourceDetail[locale]}
        </p>
      </section>
    </SiteShell>
  );
